      ...
      <div>
        ...
        <div className="absolute bottom-2 left-6  transform -rotate-90 origin-bottom-left">
          <ul className="flex space-x-4 gap-2 z-50">
            <li>
              <a className="font-semibold text-lg " href="">contact Me</a>
            </li>
            <li>
              <a className="font-semibold text-lg "href="">Portfolio</a>
            </li>
            <li>
              <a className="font-semibold text-lg" href="">Skills</a>
            </li>
            <li>
              <a className="font-semibold text-lg" href="">About Me</a>
            </li>
            <li>
